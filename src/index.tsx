...
import { MyTestProps, MyTest } from "./my-test";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/my-test.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <my-test message="world!"></my-test>
   */
  return class MyTestBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): MyTestProps {
      const attrs = this.parseAttributes<MyTestProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<MyTest {...this.props} />);
    }
